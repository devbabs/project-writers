<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <a href="index.html">
            {{-- <img alt="Logo" src="{{ asset('images/brand/logo.png') }}" class="h-25px app-sidebar-logo-default" />
            <img alt="Logo" src="{{ asset('images/brand/logo.jpg') }}" class="h-20px app-sidebar-logo-minimize" /> --}}
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    <div class="menu-item">
                        <a class="menu-link" href="#">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-white text-white svg-icon-1hx">
                    ...
                    <div class="menu-item">
                        <a class="menu-link" href="#">
                            ...
                            <span class="menu-title">HAW Not Paid</span>
                        </a>
                        <a class="menu-link" href="#">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-white text-white svg-icon-1hx">
                            ...
                            <span class="menu-title">HAW Paid</span>
                        </a>
                        <a class="menu-link" href="#">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-white text-white svg-icon-1hx">
                            ...
                            <span class="menu-title">HAW Completed</span>
                        </a>
                        <a class="menu-link" href="#">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-white text-white svg-icon-1hx">
                    ...
                    {{-- <hr style="border-color: white;border-style: dotted"> --}}
