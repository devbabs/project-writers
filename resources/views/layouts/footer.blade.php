<footer class="bg-light">
    <div class="container pb-13 pb-md-15">
      <div class="card image-wrapper bg-full bg-custom-primary-gradient mb-14">
      ...
      <div class="row gy-6 gy-lg-0">
        ...
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            ...
            <a href="cdn-cgi/l/email-protection.html#9ab9" class="link-body"><span class="__cf_email__" data-cfemail="92fbfcf4fdd2f7fff3fbfebcf1fdff">[email&#160;protected]</span></a><br /> 00 (123) 456 78 90
          </div>
          <!-- /.widget -->
        </div>
        <!-- /column -->
